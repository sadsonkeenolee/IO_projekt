  ...
  return (
    <div className="min-h-screen flex items-start justify-center pt-24 px-4">
      <div className="w-full max-w-md bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-200">
        ...
        <p className="text-sm text-white mb-6">Szybka rejestracja — wygląd bez funkcji.</p>

        <form className="space-y-4" onSubmit={(e)=>e.preventDefault()}>
          <div>
            <label className="block text-sm font-medium text-white">Imię</label>
            <input readOnly placeholder="Jan" className="mt-1 block w-full rounded-md border border-slate-300 bg-slate-50 py-2 px-3" />
          </div>
